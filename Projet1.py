...
def checklistMD(nomFichier):
    ...
    with open(nomFichier + '.md', 'r') as markdownFile:
    ...
    with open(nomFichier + 'MD.md', 'w') as markdownFile:
        markdownFile.write("".join(modifiedLines))

    with open(nomFichier + 'MD.md', 'r') as fin:
        rendered = mistletoe.markdown(fin)

    with open(nomFichier + '.html', 'w') as htmlFile:
